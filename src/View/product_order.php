<div class="container">
    ...
    <div class="d-flex">
        ...
        <div class="Yorder">
            ...
            <div>
                <input type="radio" name="dbt" value="dbt" checked> Оплата банковской картой
            </div>
            <!--<p>
                Make your payment directly into our bank account. Please use your Order ID as the payment reference. Your order will not be shipped until the funds have cleared in our account.
            </p>-->
            <div>
                <input type="radio" name="dbt" value="cd"> Оплата при получении
            </div>
            <div>
                <input type="radio" name="dbt" value="cd"> СБП <span>
...
<style>
    ...
    label>span{
        float: left;
        width: 25%;
        margin-top: 7px;    /*  отступ названий верх-вниз  */
        padding-right: 0;  /*  отступ в бок от названий табличек  */
    }
