...
<main id="cart" style="max-width:960px">
    ...
    <div class="twitter"><i class="fab fa-twitter"></i>
        <a href="/wishlist" ><svg class="heart" version="1.1" viewBox="0 0 512 512" width="50px" xml:space="preserve" id="wishlist" stroke="#727272" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
